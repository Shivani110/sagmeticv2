...
<meta property="og:image" content="{{asset('website_frontend/images/sagmetic.png')}}"/>
...
<meta name="twitter:image" content="{{asset('website_frontend/images/sagmetic.png')}}"/>
<script type="application/ld+json">
{
  ...
  "logo": "{{asset('website_frontend/images/sagmetic.png')}}",
